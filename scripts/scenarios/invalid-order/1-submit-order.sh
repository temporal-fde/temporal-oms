...
xh PUT http://localhost:8080/api/v1/commerce-app/orders/invalid-order-123 \
  customerId="cust-001" \
  order:='{"orderId":"invalid-order-123","items":[{"itemId":"shirt-001","quantity":1}],"shippingAddress":{"street":"123 Main St","city":"New York","state":"NY","postalCode":"10001","country":"US"}}'
