...
xh PUT http://localhost:8080/api/v1/commerce-app/orders/valid-order-123 \
  customerId="cust-001" \
  order:='{"orderId":"valid-order-123","items":[{"itemId":"shirt-001","quantity":1}],"shippingAddress":{"street":"388 Townsend St","city":"San Francisco","state":"CA","postalCode":"94107","country":"US"}}'
