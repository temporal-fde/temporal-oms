...
> **Next**: [v2 — Smart Fulfillment](v2-smart-fulfillment.md) replaces the legacy Kafka-based fulfillment consumer with a Temporal Smart Fulfillment Workflow powered by an LLM Shipping Agent.
