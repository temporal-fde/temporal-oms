...
| Phase 4 | Nexus integration backend reroute | ✅ Complete | Nexus handlers use `enablements-api` for commerce-app, PIMS, and inventory |
...
- **Nexus backend reroute** - complete for commerce-app, PIMS, and inventory.
